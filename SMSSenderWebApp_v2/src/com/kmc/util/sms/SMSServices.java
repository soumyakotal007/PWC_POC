...
public class SMSServices {
	...
	public String sendSingleSMS(String username, String password,
	...
	public String sendBulkSMS(String username, String password, String message,
		...
		try {
			...
			method.addParameter(new NameValuePair("senderid", senderId));
			method.addParameter(new NameValuePair("content", message));
			method.addParameter(new NameValuePair("smsservicetype", "bulkmsg"));
			method.addParameter(new NameValuePair("username", username));
			method.addParameter(new NameValuePair("password", encryptedPassword));
			method.addParameter(new NameValuePair("key", genratedhashKey));
			client.executeMethod(method);
	 ...
	 *            : Department Login Password
	 * @param message
	 *            : Unicode Message e.g. 'à¤µà¤¿à¤à¤¾à¤¸ à¤à¤£à¤¿
	...
	public String sendUnicodeSMS(String username, String password,
		...
		try {
			...
			method.addParameter(new NameValuePair("smsservicetype",
					"unicodemsg"));
			method.addParameter(new NameValuePair("username", username));
			method.addParameter(new NameValuePair("password", encryptedPassword));
			method.addParameter(new NameValuePair("key", genratedhashKey));
	...
	public String sendOtpSMS(String username, String password, String message,
			String senderId, String mobileNumber, String secureKey) {
		String response = null;
		String encryptedPassword;
		String genratedhashKey = hashGenerator(username, senderId, message,
		...
		try {
			...
			method.addParameter(new NameValuePair("senderid", senderId));
			method.addParameter(new NameValuePair("content", message));
			method.addParameter(new NameValuePair("smsservicetype", "otpmsg"));
			method.addParameter(new NameValuePair("username", username));
			method.addParameter(new NameValuePair("password", encryptedPassword));
			method.addParameter(new NameValuePair("key", genratedhashKey));
			client.executeMethod(method);
	...
	protected String hashGenerator(String userName, String senderId,
	 ...
	 * 
	 * @param message
	 *            e.g. 'à¤µà¤¿à¤à¤¾à¤¸ à¤à¤£à¤¿ à¤ªà¥à¤°à¤à¤¤
